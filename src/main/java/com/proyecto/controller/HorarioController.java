...
public class HorarioController {
    ...
    public String showEditHorario(@PathVariable Integer id, Model model) {
        try {
    ...
    public String showViewHorario(@PathVariable Integer id, Model model) {
        try {
            model.addAttribute("horario", horarioService.getHorario(id));
    ...
    public String removeHorario(@PathVariable Integer id) {
    ...
    public String showConsultaHorarios(Model model) {
        model.addAttribute("barbero", new Barbero()); // Para el select
        model.addAttribute("barberoList", barberoService.getAll());
